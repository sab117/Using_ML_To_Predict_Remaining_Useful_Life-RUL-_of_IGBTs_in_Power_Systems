...
df = pd.read_pickle("Set_3_Train_Data.pkl")
df1 = pd.read_pickle("Set_3_Test_Data.pkl")
print(df)
#print(df1)
...
plt.title('Average collector current Linear Regression model (3rd Hour of Data)')
plt.grid()
plt.show()
