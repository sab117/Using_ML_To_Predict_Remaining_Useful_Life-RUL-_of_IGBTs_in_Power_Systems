...
##################################################################
df = pd.read_pickle("Full_Train_Data.pkl")
print(df)
...
plt.grid()
plt.xlabel('Time Diffrence (Epoch)')
plt.ylabel('Collector Current (A)')
plt.title('Finding Pulse Width Time diffrence')
plt.show()
#######################################################################
...
#df2.to_excel('Data_Full.xlsx') #Not needed 
